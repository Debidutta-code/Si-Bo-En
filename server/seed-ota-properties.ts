...
async function main() {
    ...
    try {
        ...
        if (!adminUser) {
            console.log('No super_admin user found. Creating a dummy admin user...');
        ...
        const dummyProperties = [
            ...
            },
            {
                ...
                category: luxuryCategory.id,
                type: hotelType.id,
                image: ['https://images.unsplash.com/photo-1551882547-ff40c0d128dc']
            }
        ];

        for (const dp of dummyProperties) {
            console.log(`Creating Creation & Property for: ${dp.propertyName}...`);
            ...
            console.log(`✅ Successfully created property: ${dp.propertyName} (Code: ${dp.propertyCode})`);
        }
