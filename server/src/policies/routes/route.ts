...
router.route("/").post(protect, checkRoleBased("canCreatePolicy"), attachPropertyDetails({
    identifierType: "id",
    key: "propertyId",
    source: "body"
...
router.route("/getPolicy").
    post(protect, checkRoleBased("canViewHotel"), attachPropertyDetails({
        identifierType: "code",
        key: "propertyCode",
        source: "body"
...
router.route("/addToRatePlan").post(
    protect,
