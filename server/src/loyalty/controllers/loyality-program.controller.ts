...
export class AdvanceLoyaltyProgramController {
    ...
    public async createAdvanceLoyaltyProgram(
        ...
        try {
            ...
            const result =
                await this.advanceLoyaltyProgramService.createAdvanceLoyaltyProgram(
                    data
                );
            return res.status(result.success ? 201 : 400).json(result);
        } catch (error) {
    ...
    public async getAdvanceLoyaltyProgram(
        req: CustomRequest,
        res: Response
    ): Promise<Response> {
        try {
            ...
            const result =
                await this.advanceLoyaltyProgramService.getAdvanceLoyaltyPrograms(
                    loyaltyProgramId
                );
            return res.status(result.success ? 200 : 404).json(result);
        } catch (error) {
            ...
            if (!id) {
                return res
                    ...
                    .json(
                        errorResponse(
                            'Invalid Request',
                            'Advance Loyalty Program ID is required'
                        )
                    );
            }

            const result =
                await this.advanceLoyaltyProgramService.updateAdvaceLoyaltyPrograms(
                    id,
                    data
                );
            return res.status(result.success ? 200 : 400).json(result);
    ...
    public async deleteAdvanceLoyaltyProgram(
        ...
        try {
            ...
            const result =
                await this.advanceLoyaltyProgramService.deleteAdvanceLoyaltyPrograms(
                    id
                );
            return res.status(result.success ? 200 : 400).json(result);
        } catch (error) {
