...
export class OtaUserController {
    ...
    public async registerUser(
        ...
        try {
            ...
            if (validationError) {
                return res
                    .status(400)
                    .json(errorResponse('Invalid user data', validationError));
            }
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(
                        errorResponse('Failed to register user', error.message)
                    );
            }
            return res
                .status(500)
                .json(
                    errorResponse('Failed to register user', 'Unknown error')
                );
        }
    }
        ...
        try {
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(
                        errorResponse('Failed to verify user', error.message)
                    );
            }
            return res
                .status(500)
                .json(errorResponse('Failed to verify user', 'Unknown error'));
        }
    }
    public async getOtaUser(
    ...
    public async updatePassword(
        ...
        try {
            ...
            if (validationError) {
                return res
                    .status(400)
                    .json(errorResponse('Invalid password', validationError));
            }
            ...
            return res
                .status(500)
                .json(
                    errorResponse('Failed to update password', 'Unknown error')
                );
        }
    }
    ...
    public async deleteUser(
        ...
        try {
            ...
            return res
                .status(500)
                .json(errorResponse('Failed to delete user', 'Unknown error'));
        }
    }
    public async loginUser(
        ...
        try {
            ...
            if (emailError) {
                return res
                    .status(400)
                    .json(errorResponse('Invalid email format', emailError));
            }
            ...
            if (passwordError) {
                return res
                    .status(400)
                    .json(
                        errorResponse('Invalid password format', passwordError)
                    );
            }
            ...
            return res
                .status(200)
                .cookie('revvChillOtaAccess', result.data, {
                    httpOnly: true,
                })
            ...
            if (error instanceof Error) {
                return res
                    .status(500)
                    .json(errorResponse('Failed to login', error.message));
            }
            return res
                .status(500)
