...
propertyWishlistRouter.route("/")
    .post(propertyWishController.addToWishlist.bind(propertyWishController))
    .get(propertyWishController.getWishlistForUser.bind(propertyWishController));

propertyWishlistRouter.route("/:propertyId")
    .delete(propertyWishController.removeFromWishlist.bind(propertyWishController));
