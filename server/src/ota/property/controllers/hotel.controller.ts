...
export class HotelController {
    public static fetchHotels = asyncHandler(async (req: Request, res: Response) => {
    ...
    public static fetchAutocompleteHotels = asyncHandler(async (req: Request, res: Response) => {
        // Extract filters from query parameters
        const query: HotelFilterQuery = {
            page: req.query.page as string,
            limit: req.query.limit as string,
        ...
        const data = await HotelService.fetchAutocompleteHotels(query);
