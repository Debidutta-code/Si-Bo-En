...
export default class CreationDao {
    ...
    public static async getAllDeleted(
        ...
        try {
            ...
            throw new Error(
                `Failed to fetch deleted creations: ${error.message}`
            );
        }
    }
    ...
    public static async assignToCustom(
        targetCreationId: string,
        customCreationId: string
    ) {
        try {
    ...
    public static async getSpecificCreation(
        ...
        try {
            ...
            throw new Error(
                `Failed to get specific creation: ${error.message}`
            );
        }
    }
}
...
export class ManageCreationUser {
    private static async addUserToLevel(
        ...
        try {
            ...
            throw new Error(
                `Failed to add user to ${levelField}: ${error.message}`
            );
        }
    }
    ...
    private static async removeUserFromLevel(
        ...
        try {
            ...
            throw new Error(
                `Failed to remove user from ${levelField}: ${error.message}`
            );
        }
    }
...
export class CreationDetailsByUserId {
    public static async getGroupManagersGroup(groupManagerId: string) {
        try {
            ...
            throw new Error(
                `Failed to get group for manager: ${error.message}`
            );
        }
    }
    ...
    public static async getGroupManagersBrands(groupManagerId: string) {
        try {
            ...
            throw new Error(
                `Failed to get brands for group manager: ${error.message}`
            );
        }
    }
    ...
    public static async getGroupManagersProperty(groupManagerId: string) {
        try {
            ...
            throw new Error(
                `Failed to get properties for group manager: ${error.message}`
            );
        }
    }
    ...
    public static async getBrandManagersBrand(brandManagerId: string) {
        try {
            ...
            throw new Error(
                `Failed to get brand for manager: ${error.message}`
            );
        }
    }
    ...
    public static async getBrandManagersProperty(brandManagerId: string) {
        try {
            ...
            throw new Error(
                `Failed to get properties for brand manager: ${error.message}`
            );
        }
    }
    ...
    public static async getPropertyManagersProperty(propertyManagerId: string) {
        try {
            ...
            throw new Error(
                `Failed to get property for manager: ${error.message}`
            );
        }
    }
    ...
    public static async getLevel0UsersProperty(id: string) {
        try {
            ...
            throw new Error(
                `Failed to get property for level 0 user: ${error.message}`
            );
        }
    }
}
...
export class CreationDetailsByCreationId {
    ...
    public static async getGroupManagersProperty(groupId: string) {
        try {
            ...
            throw new Error(
                `Failed to get properties for group: ${error.message}`
            );
        }
    }
    ...
    public static async getBrandManagersProperty(brandId: string) {
        try {
            ...
            throw new Error(
                `Failed to get properties for brand: ${error.message}`
            );
        }
    }
...
export class AddCreationToCreation {
    ...
    public static async addToProperty(
