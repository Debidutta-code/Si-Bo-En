...
export default function AddOns() {
    ...
    const [selectedAddonForAvailability, setSelectedAddonForAvailability] = useState<IAddon | null>(null);
    const [availabilities, setAvailabilities] = useState<IAddonAvailability[]>([]);
    
    const [loader, setLoader] = useState<LoaderProps>({ isLoading: false, message: "" });
    
    // Dialog states
    const [addOnDialog, setAddOnDialog] = useState<{ open: boolean; mode: "create" | "edit"; addOn: IAddon | null }>({
        open: false,
        mode: "create",
        addOn: null,
    });
    const [categoryDialog, setCategoryDialog] = useState<{ open: boolean; mode: "create" | "edit"; category: IAddonCategory | null }>({
        open: false,
        mode: "create",
        category: null,
    });
    const [subCategoryDialog, setSubCategoryDialog] = useState<{ open: boolean; mode: "create" | "edit"; subCategory: IAddonSubCategory | null }>({
        open: false,
        mode: "create",
        subCategory: null,
    });
    const [variantDialog, setVariantDialog] = useState<{ open: boolean; mode: "create" | "edit"; variant: IAddonVariant | null }>({
        open: false,
        mode: "create",
        variant: null,
    });
    const [deleteDialog, setDeleteDialog] = useState<{ open: boolean; addOn: IAddon | null }>({
        open: false,
        addOn: null,
    });
    ...
    const handleCreateAddOn = async (data: IAddonCreate | IAddonUpdate) => {
        ...
        try {
            const response = await createAddOnService(data as IAddonCreate, propertyId);
            if (response.success) {
    ...
    const handleUpdateAddOn = async (data: IAddonCreate | IAddonUpdate) => {
        ...
        try {
            const response = await updateAddOnService(addOnDialog.addOn.id, data as IAddonUpdate);
            if (response.success) {
    ...
    const handleUpdateCategory = async (data: IAddonCategoryCreate) => {
        ...
        try {
            const response = await updateCategoryService(categoryDialog.category.id, data);
            if (response.success) {
    ...
    const handleCreateSubCategory = async (data: IAddonSubCategoryCreate) => {
        ...
        try {
            ...
            if (response.success) {
                ...
                setSubCategoryDialog({ open: false, mode: "create", subCategory: null });
                fetchSubCategories();
            } else {
    ...
    const handleUpdateSubCategory = async (data: IAddonSubCategoryCreate) => {
        ...
        try {
            const response = await updateSubCategoryService(subCategoryDialog.subCategory.id, data);
            if (response.success) {
    ...
    const handleUpdateVariant = async (data: IAddonVariantCreate) => {
        ...
        try {
            const response = await updateVariantService(variantDialog.variant.id, data);
            if (response.success) {
    ...
    const handleUpdateAvailability = async (
        ...
        try {
            ...
            const response = await updateAvailabilityService(availabilityId, updateData);
            if (response.success) {
            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Manage additional services and amenities</p>
                            </div>
                        </div>
                        <Button 
                ...
                {showManagement ? (
                    ...
                    <ManagementTabs
                        ...
                        variants={variants}
                        onCreateCategory={() => setCategoryDialog({ open: true, mode: "create", category: null })}
                        onEditCategory={(category) => setCategoryDialog({ open: true, mode: "edit", category })}
                        onDeleteCategory={handleDeleteCategory}
                        onCreateSubCategory={() => setSubCategoryDialog({ open: true, mode: "create", subCategory: null })}
                        onEditSubCategory={(subCategory) => setSubCategoryDialog({ open: true, mode: "edit", subCategory })}
                        onDeleteSubCategory={handleDeleteSubCategory}
                        onCreateVariant={() => setVariantDialog({ open: true, mode: "create", variant: null })}
                        onEditVariant={(variant) => setVariantDialog({ open: true, mode: "edit", variant })}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <Card>
                                <CardContent className="p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-gray-600">Inactive Add-Ons</p>
                            ...
                            <CardContent className="p-6">
                                <div className="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button onClick={() => setAddOnDialog({ open: true, mode: "create", addOn: null })}>
                        ...
                        {filteredAddOns.length === 0 ? (
                            <Card className="shadow-lg">
                                <CardContent className="p-12 text-center">
                                    ...
                                    <h3 className="text-lg font-semibold text-gray-700 mb-2">No Add-Ons Found</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredAddOns.map((addOn) => (
                                    <Card key={addOn.id} className="hover:shadow-xl transition-shadow duration-200">
                                            ...
                                            <div className="flex items-start justify-between">
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        <DropdownMenuItem onClick={() => handleManageAvailability(addOn)}>
                                                            <Calendar className="w-4 h-4 mr-2" />
                                                            Manage Availability
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onClick={() => setAddOnDialog({ open: true, mode: "edit", addOn })}>
                                                            <Pencil className="w-4 h-4 mr-2" />
                                                            Edit
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem
                                                            onClick={() => setDeleteDialog({ open: true, addOn })}
                ...
                <AddOnDialog
                    ...
                    onOpenChange={(open) => setAddOnDialog({ open, mode: "create", addOn: null })}
                ...
                <CategoryDialog
                    ...
                    onOpenChange={(open) => setCategoryDialog({ open, mode: "create", category: null })}
                ...
                <SubCategoryDialog
                    ...
                    onOpenChange={(open) => setSubCategoryDialog({ open, mode: "create", subCategory: null })}
                ...
                <VariantDialog
                    ...
                    onOpenChange={(open) => setVariantDialog({ open, mode: "create", variant: null })}
                ...
                <AlertDialog open={deleteDialog.open} onOpenChange={(open) => setDeleteDialog({ open, addOn: null })}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle>Are you sure?</AlertDialogTitle>
                            <AlertDialogDescription>
                                This will permanently delete the add-on "{deleteDialog.addOn?.name}". 
