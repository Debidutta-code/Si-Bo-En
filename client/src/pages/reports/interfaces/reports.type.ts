...
export type ReportType=    'comparison'|'reservation-overview'|'revenue-analytics'|'insights'|'top-properties'|'all-reservations'|'checkin-checkout'|'status-breakdown'|'loyalty-guests'|'payment-status'
