...
export default function CheckRoomLangDialog({ open, onOpenChange, roomId }: Props) {
              ...
              Object.entries(translations).map(([locale, data]) => (
                <div key={locale} className="flex justify-between items-center border p-4 rounded-md shadow-sm">
                  <div>
                    ...
                    <p className="text-sm text-gray-600"><span className="font-medium">Type:</span> {data.roomType}</p>
                  </div>
