                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Select value={roomDetails.roomType} onValueChange={(value) => updateroomDetails({ roomType: value })}>
                        ...
                        <SelectContent className="bg-white border border-gray-300">
                          <SelectItem value="Standard" className="hover:bg-gray-100">Standard</SelectItem>
                          <SelectItem value="Deluxe" className="hover:bg-gray-100">Deluxe</SelectItem>
                          <SelectItem value="Suite" className="hover:bg-gray-100">Suite</SelectItem>
                          <SelectItem value="Premium" className="hover:bg-gray-100">Premium</SelectItem>
                          <SelectItem value="Executive" className="hover:bg-gray-100">Executive</SelectItem>
                        </SelectContent>
                      </Select>
