        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                <CalendarIcon className="mr-2 h-4 w-4" />
                {filters.checkOut ? format(filters.checkOut, "PPP") : "Check-out"}
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {filters.guests} Guests, {filters.rooms} Rooms
              </Button>
            </PopoverTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      variant="outline"
                      size="icon"
                      onClick={() => updateFilters({ guests: filters.guests + 1 })}
                    >
                      +
                    </Button>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Input
                      ...
                      type="number"
                      value={filters.rooms}
                      onChange={(e) => updateFilters({ rooms: parseInt(e.target.value) || 1 })}
                      className="text-center"
                      min={1}
                    />
                    <Button
